...
# Engine root = directory containing this script (portable; no hard-coded host path)
...
# 默认 harness（AI 主脑瘦面）；需要全量工具时显式 export KALI_MCP_TOOL_PROFILE=full
export KALI_MCP_TOOL_PROFILE="${KALI_MCP_TOOL_PROFILE:-harness}"
