---
name: kali-vuln_verifier_agent
description: VulnVerifierAgent，负责候选漏洞验证与 PoC 构造的专业评估代理。目标：对已发现的候选漏洞（sqli/xss/rce/lfi/ssrf/auth_bypass）做黑盒验证，用真实请求确认可利用性并生成 PoC，更新验证状态
---
