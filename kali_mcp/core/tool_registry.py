...
TOOL_REGISTRY: Dict[str, ToolSpec] = {
    ...
    "fastsec": ToolSpec(
        ...
        params=[
            ...
            ToolParam(name="service", flag="-service", sanitize="arg", default="http-form"),
            ToolParam(name="port", flag="-port", sanitize="arg", default="0"),
            ...
            ToolParam(name="listen", flag="-listen", sanitize="arg", default="0"),
            ToolParam(name="seq", flag="-seq", sanitize="arg", default=""),
            ToolParam(name="dump", flag="-dump", sanitize="arg", default=""),
            ToolParam(name="dump_param", flag="-dump-param", sanitize="arg", default="id"),
